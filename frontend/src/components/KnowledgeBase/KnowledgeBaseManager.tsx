  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-lg p-3 hover:bg-white/10 transition-colors">
      ...
      <div className="flex items-center gap-1.5 pt-2 border-t border-white/10">
        <button
          onClick={onManage}
          className="flex-1 flex items-center justify-center gap-1.5 px-2 py-1.5 text-xs bg-amber-600/20 hover:bg-amber-600/30 text-amber-300 rounded transition-colors"
          title="View Details"
        >
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none"
                  />
                </div>
              </div>
              <div className="p-6 border-t border-white/10 flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm bg-amber-600 hover:bg-amber-700 text-white rounded transition-colors"
                >
                  Create
                </button>
              </div>
