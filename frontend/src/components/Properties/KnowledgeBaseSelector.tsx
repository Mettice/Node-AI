      ...
      {showVersion && selectedKB && onVersionChange && (
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-sm"
          />
        </div>
      )}
    </div>
